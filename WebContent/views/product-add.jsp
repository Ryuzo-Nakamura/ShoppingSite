...
<form action="/ShoppingSite/servlet/manga-search" method="post">
	...
	<input type="text" name="adminSearchTitle" class="form-text" value="<c:if test="${adminSearchTitle != null}">${adminSearchTitle}</c:if>" maxlength="256">
	
	<p class="btn_p">
		<input type="button" value="新規"  class="medium-btn reverse-btn" onclick="location.href='/ShoppingSite/views/manga-add.jsp'">
...
<c:forEach var="manga" items="${adminMangaList}">
	<form action="/ShoppingSite/servlet/manga-management" method="post">
		...
		<div class="manga-list management-manga-list">
